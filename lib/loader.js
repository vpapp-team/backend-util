...
const main = module.exports = (reload = false) => readDir(__dirname, undefined, reload);

const readDir = main.readDir = (dir, master, reload = false) => {
  const resp = new Map();
  resp.dir = PATH.resolve(master, dir);
