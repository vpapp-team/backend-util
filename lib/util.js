...
exports.acceptFile = (resp, filePath, headerOverwrite, range, statusCode = 200) => {
  FS.stat(filePath, (err, stats) => {
    if (err) {
      LOGGER.error('failed to stat file', filePath, err);
...
exports.requestMaster = (module, cb, ...args) => {
  LOGGER.debug('requestMaster', module, !!cb, args);
 ...
 */
String.prototype.removeHTML = () => new HTML_ENTITIES.AllHtmlEntities().decode(this
  .replace(/\n/g, ' ')
